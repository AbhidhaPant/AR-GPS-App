...
public class GPS : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        // 5 indicate the gps location upto the range of 5m and 10 represent 
        // change the location or update gps if the device is moved 10m from its previous location.
